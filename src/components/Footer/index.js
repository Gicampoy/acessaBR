...
import './footer.scss'
import iconTop from '../../images/icons/icon-top.png'
            ...
            <div className="footer__section footer__section--second">
                <div className="footer__container">
                    <p>
                        ...
                        <small>
                            Projetado por <a href="https://github.com/cavalcantemmarcelo"   target="_blank" > Marcelo Cavalcante </a> e <a href="https://github.com/mja-maia" target="_blank" > Miguel Maia </a>,   desenvolvido por <a href="https://github.com/matheuscmorais356" target="_blank" >  Matheus Cardoso</a>.
                        </small>
                    </p>
